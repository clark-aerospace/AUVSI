...
export function createPlanning(missionFile, plan) {
  ...
  var flyZonesDict = missionFile['flyZones'][0];
      ...
      // build planning wayPoints coordinates
      var wayPointList = plan['waypoints'];
      var planCoordinates = [];
      for (let dictionary of wayPointList) {
  ...
  var createMap = function() {
    ...
    // create Polyline from plan coordinates
    var planPath = new google.maps.Polyline({
